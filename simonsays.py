...
pygame.display.update()
beep_sound = pygame.mixer.Sound('C:\\Users\\bhavya\\OneDrive\\codes\\python\\simonsays-py\\beep.wav')
intro_sound = pygame.mixer.Sound('C:\\Users\\bhavya\\OneDrive\\codes\\python\\simonsays-py\\intro.wav')
def intro():
    intro_sound.play()
def beep():
    beep_sound.play()
